...
import penguinAssistant from "@/assets/penguin-assistant.jpg";


export const Greeting = () => {
  const [isChatOpen, setIsChatOpen] = useState(false);
  const [messages, setMessages] = useState([
    { text: "Hi! I'm your Penguin Assistant. Ask me anything about Rushika's skills, projects, or experience!", isBot: true }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { text: "Sorry, I'm having trouble responding right now. Please try asking about Rushika's projects, skills, or experience!", isBot: true }]);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      >
        ...
        >
          <div className="relative inline-block">
            <img
              src={penguinAssistant}
              alt="Penguin Assistant"
              className="w-40 h-40 md:w-48 md:h-48 mx-auto cursor-pointer transition-all duration-300 group-hover:scale-110 object-contain rounded-full border-4 border-accent shadow-xl"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-border">
              <h3 className="font-semibold">Penguin Assistant</h3>
              <button
                onClick={() => setIsChatOpen(false)}
            ...
            <div className="p-4 border-t border-border">
              <div className="flex gap-2">
                <input
                  ...
                  disabled={isLoading}
                  placeholder="Ask me about Rushika..."
