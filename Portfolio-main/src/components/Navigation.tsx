...
export const Navigation = () => {
  ...
  const socialLinks = [
    ...
    { icon: FiGithub, href: "https://github.com/Rushikaputta", label: "GitHub" },
    { icon: FiLinkedin, href: "https://www.linkedin.com/in/rushika-putta-683766307", label: "LinkedIn" },
    { icon: FiMail, href: "mailto:rushikaputta1105@gmail.com", label: "Email" },
  ];
